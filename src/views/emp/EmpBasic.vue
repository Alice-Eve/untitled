  ...
  <div>
    <div style="display: flex;justify-content: space-between">
      <div>
        ...
        <el-button size="small" icon="el-icon-search" type="primary" @click="initEmps">搜索</el-button>
        <el-button size="small" type="primary"><i class="fa fa-angle-double-up" aria-hidden="true"></i>高级搜索</el-button>
      </div>
      <div>
        <el-upload
    ...
    <el-dialog
          ...
          <el-row>
            <el-col :span="6">
              <el-form-item label="姓名:" prop="name" size="mini">
                <el-input prefix-icon="el-icon-edit" style="width: 150px" v-model="emp.name"
          ...
          <el-row>
            ...
            <el-col :span="5">
              <el-form-item label="籍贯:" prop="nativePlace" size="mini">
                <el-input prefix-icon="el-icon-edit" style="width: 150px" v-model="emp.nativePlace"
                          placeholder="请输入籍贯"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="6">
              <el-form-item label="电子邮箱:" prop="email" size="mini">
                <el-input prefix-icon="el-icon-message" style="width: 150px" v-model="emp.email"
                          placeholder="请输入电子邮箱"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="7">
              <el-form-item label="联系地址:" prop="address" size="mini">
                <el-input prefix-icon="el-icon-edit" style="width: 200px" v-model="emp.address"
          ...
          <el-row>
            ...
            <el-col :span="7">
              <el-form-item label="电话号码:" prop="phone" size="mini">
                <el-input prefix-icon="el-icon-phone" style="width: 200px" v-model="emp.phone"
          ...
          <el-row>
            <el-col :span="6">
              <el-form-item label="工号:" prop="workID" size="mini">
                <el-input :disabled="true" style="width: 150px" v-model="emp.workID" placeholder="工号"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="5">
            ...
            <el-col :span="6">
              <el-form-item label="毕业院校:" prop="school" size="mini">
                <el-input prefix-icon="el-icon-edit" style="width: 150px" v-model="emp.school"
                          placeholder="请输入毕业院校"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="7">
              <el-form-item label="专业名称:" prop="specialty" size="mini">
                <el-input prefix-icon="el-icon-edit" style="width: 200px" v-model="emp.specialty"
          ...
          <el-row>
            <el-col :span="8">
              <el-form-item label="身份证号码:" prop="idCard" size="mini">
                <el-input prefix-icon="el-icon-edit" style="width: 200px" v-model="emp.idCard"
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="doAddEmp" size="mini">确 定</el-button>
      </span>
    </el-dialog>
  </div>
</template>
